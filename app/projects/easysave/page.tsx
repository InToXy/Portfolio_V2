      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <Card className="animate-in slide-in-from-bottom-4 mb-8 delay-400 duration-700">
          ...
          <CardContent className="space-y-4">
            <p>
              Projet académique réalisé dans le cadre d&apos;un éditeur logiciel fictif (ProSoft),
              visant à développer un logiciel de sauvegarde performant et évolutif destiné à des
              utilisateurs professionnels.
            </p>
            <p>
              L&apos;objectif était de créer une solution fiable et simple d&apos;utilisation, avec
              de fortes attentes en termes de performance et de maintenabilité du code.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="animate-in slide-in-from-bottom-4 mb-8 delay-600 duration-700">
          ...
          <CardContent className="space-y-4">
            <div>
              <h4 className="mb-2 font-semibold">Architecture MVC</h4>
              <ul className="text-muted-foreground space-y-1 text-sm">
            ...
            <div>
              <h4 className="mb-2 font-semibold">Technologies Core</h4>
              <ul className="text-muted-foreground space-y-1 text-sm">
        ...
        <Card className="animate-in slide-in-from-bottom-4 mb-8 delay-700 duration-700">
          ...
          <CardContent className="space-y-4">
            <div>
              <h4 className="mb-2 font-semibold">Méthodologie Agile</h4>
              <ul className="text-muted-foreground space-y-1 text-sm">
            ...
            <div>
              <h4 className="mb-2 font-semibold">Versioning et Documentation</h4>
              <ul className="text-muted-foreground space-y-1 text-sm">
