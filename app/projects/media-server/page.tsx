...
import { ArrowLeft, Github, Server, Cloud, HardDrive, Zap } from 'lucide-react'
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="animate-in slide-in-from-top-4 mb-8 duration-700">
          ...
          <p className="text-muted-foreground text-xl">
            Mise en place d&apos;une solution complète de gestion et de diffusion de contenu
        ...
        <div className="animate-in slide-in-from-bottom-4 mb-8 delay-200 duration-700">
          <Image
            ...
            width={1000} // Placeholder: please adjust if actual image dimensions are different
        ...
        <Card className="animate-in slide-in-from-bottom-4 mb-8 delay-400 duration-700">
          ...
          <CardContent className="space-y-4">
            <p>
              Ce projet consiste en la conception et le déploiement d&apos;un serveur multimédia
              personnel robuste et automatisé, permettant de centraliser, organiser et diffuser des
              films, séries et autres contenus. L&apos;objectif était de créer une infrastructure
              flexible et facile à maintenir grâce à la conteneurisation.
            </p>
            <p>
              J&apos;ai utilisé Docker et Docker Compose pour orchestrer plusieurs services, chacun
              ayant un rôle spécifique dans la chaîne de gestion multimédia : Plex pour la
              diffusion, Radarr pour la gestion des films, Jackett pour l&apos;indexation,
              Transmission pour le téléchargement, et Flaresolverr pour contourner les protections
              anti-bot. Cette approche modulaire assure une grande scalabilité et une maintenance
              simplifiée.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="animate-in slide-in-from-bottom-4 mb-8 delay-600 duration-700">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground mb-2 text-sm">
              Voici un extrait simplifié de la configuration Docker Compose utilisée pour orchestrer
              les services :
            </p>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <ul className="text-muted-foreground space-y-1 text-sm">
                ...
                <li>
                  • Mise en place d&apos;une architecture conteneurisée pour une meilleure
